...
// Also, there is a autocloseable interface
public class MySQLConnection implements AutoCloseable {
    ...
    public MySQLConnection() throws MySQLException {
        try {
            ...
            e.printStackTrace();
            throw new MySQLException("Failed to connected to database.");
        }
    }
    ...
    public void setFavoriteItem(String userId, Item item) throws MySQLException {
        if (conn == null) {
            String errorMessage = "DB connection failed (conn is null).";
    ...
    public Set<String> getFavoriteItemIds(String userId) throws MySQLException, SQLException {
        /**
    ...
    // The returned map includes three entries
    // like {"Video": [item1, item2, item3], "Stream": [item4, item5, item6], "Clip": [item7, item8, ...]}
    public Map<String, List<Item>> getFavoriteItems(String userId) throws MySQLException, SQLException {
        if (conn == null) {
            System.err.println("DB connection failed");
            throw new MySQLException("Failed to connect to Database");
        }
